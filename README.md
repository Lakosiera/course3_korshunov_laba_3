# Лаба 3 Первое приложение на Django. Cookies

## Задание

- [x] Создать новый проект на Django.
- [x] Создать html-форму в соответствии со своим вариантом. 
- [x] Определить стили страницы через внешнюю страницу стилей. 
- [x] Добавить текстовый и графический контент на страницу под тематику вашего варианта. 
- [x] Реализовать функционал для сохранения пользовательских настроек с использованием cookies, таких как темы, язык интерфейса или последние посещенные страницы.
